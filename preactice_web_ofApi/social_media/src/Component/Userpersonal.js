...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                ...
                const updatedAlbums = splicedAlbums.map((album) => ({
                    ...album,
                    likes: Math.floor(Math.random() * (2400000 - 100000) + 100000),
                }));
        ...
        setTimeout(() => {
            setTotalLikes(Math.floor(Math.random() * (11000000 - 100000) + 100000));
            setTotalFollowers(Math.floor(Math.random() * (11000000 - 100000) + 100000));
        }, 100);
            ...
            <div className="user-container">
                <div className="profile-content">
                    <div className="profile-header">
                        ...
                        <img src={require(`../Component/image/0${id}.jpg`)} alt="" /> 
                        </div>
